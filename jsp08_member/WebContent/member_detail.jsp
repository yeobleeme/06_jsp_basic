		...
		<table class="table table-dark text-light">
			...
			<tr>
				<td colspan="2" align="center">
					<input type="button" class="btn btn-success mr-md-3" value="정보 수정" 
						onclick="location.href='detail?id=<%= member.getId() %>&type=u'" />
					<input type="button" class="btn btn-success mr-md-3" value="회원 삭제" 
						onclick="location.href='delete?id=<%= member.getId() %>'" />
					<input type="button" class="btn btn-success mr-md-3" value="목록 조회" 
