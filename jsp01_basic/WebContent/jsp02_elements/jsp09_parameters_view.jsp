...
<!--
    ...
    설정하지 않아도 utf-8문자셋을 사용한다. 하지만 utf-8이 아닌 문자셋을 
    get 방식으로 전달하는 경우에는 server.xml의
    <Connector>태크의 useBodyEncodingForURI속성을 true로 추가하면 된다.
...
<body>
	<h1>jsp09_paramether_view.jsp</h1>
	<h2>요청된 파라미터 정보</h2>
	<h3> <%= request %></h3>
	<hr />
