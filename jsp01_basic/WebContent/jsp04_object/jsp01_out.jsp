...
<!--
	1. out 기본객체
	  ...
	  1) out객체의 출력메서드
	   ...
	   b. println() : 데이터를 출력 후 줄바꿈
	   c. newLine() : 줄바꿈
	   d. write() : dom태그를 html로 출력
	  
	  2) out객체의 buffer관련 메서드 
	  
	   a. getBufferSize() : 버퍼 크기를 리턴
	   b. getRemaining() : 버퍼의 잔량을 리턴
	   c. clear() : 버퍼 전체를 비움, 이미 flush가 되어 있다면 예외 발생
	   d. clearBuffer() : 버퍼 전체를 비움, 이미 flush가 되어 있어도 예외가 발생하지 않음
...
<body>
	<% out.print("<h1>안녕하세요. out기본객체 입니다.</h1>"); %>
	<% out.print("안녕하세요"); %>
	<% out.print("반갑습니다"); %>
