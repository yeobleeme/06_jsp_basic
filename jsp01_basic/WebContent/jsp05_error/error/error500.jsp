...
<body>
	...
	<div class="bg-primary text-white">500 서버에 에러가 발생했습니다.</div>
	<div class="bg-primary text-white">500 파라미터를 찾지 못했습니다.</div>
	<div class="bg-primary text-white">500 신속히 복구중.</div>
</body>
</html>
